...
class GetLocalCategories implements UseCase<List<Category>, NoParams> {
  final CategoryRepository _categoryRepository;

  GetLocalCategories(this._categoryRepository);

  @override
  Future<Either<Failure, List<Category>>> call(NoParams params) async {
    return await _categoryRepository.getLocalCategories();
  }
}
